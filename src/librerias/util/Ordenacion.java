 ...
 *  - La implementación de los algoritmos de ordenacion in-situ DyV
 *    Quick Sort y Merge Sort. 
 *  - Un método para comprobar si dos arrays genéricos son iguales.
 *  
 * @author (EDA) 
...
public class Ordenacion {
    ...
    /** 
     *  Algoritmo de ordenación quicksort (Hoare, 1963).
     *  Utiliza el algoritmo de partición debido a Weiss,
     *  con mediana de 3 para el cálculo del pivote.
     *  
    ...
    private static <T extends Comparable<T>> void quickSort(T[] a, 
        ...
        if (izq < der) {
            ...
            intercambiar(a, i, j);        // Deshacer el ú cambio
    ...
    private static <T extends Comparable<T>> T mediana3(T[] a, 
        ...
        // ocultar el pivote en la posición der-1
        intercambiar(a, c, der - 1);
        return a[der - 1];
    }

    // MERGE SORT --------------------------------------------   
    // VERSION 1 (vista en teoría):
    /**
    ...
    /**
     * SII i<=f: ordena ascendentemente el sub-array v[i, f].
     * 
    ...
    /**
     * Mezcla internamente los sub-arrays v[i, m] y v[m + 1, f],
     * ambos ordenados Asc.
     * 
     * @param v  Sus elementos implementan la interfaz Comparable
    ...
    */
    ...
    public static <T extends Comparable<T>> void mergeSort2(T[] v) {
        ...
        System.arraycopy(res, 0, v, 0, res.length);
    }
    
    /**
     * SII i≤f: devuelve un array con los elementos del sub-array
     * v[i, f] ordenados Asc. 
     * 
     * @param v  Sus elementos implementan la interfaz Comparable
     * @param i  Extremo inferior del intervalo a ordenar
